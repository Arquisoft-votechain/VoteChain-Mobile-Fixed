...
class AdministratorRegisterView extends StatelessWidget {
  const AdministratorRegisterView({Key? key}) : super(key: key);
      ...
      children: [
        TextButton(
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => AdministratorLoginView()),
            );
          },
